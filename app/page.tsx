...
function OwnerView() {
  ...
  return (
    <div className="phone-content owner-view">
      ...
      <section className="check-in-rule-card" aria-label="Jobsite check-in rules"><div className="rule-icon"><ShieldCheck size={18} /></div><div><strong>Jobsite check-in rules</strong><p>PIN or address required</p><small>Hearthside Bakery · 804 Juniper Ave</small></div><span className="rule-state">On</span></section>
